...
public class RecipeFilterDialog {
     ...
     * Proporciona callback cuando se aplican los filtros seleccionados.
     */
    public interface OnFilterAppliedListener {
        /**
         * Se llama cuando se aplican los filtros seleccionados.
         *
         * @param recetasFiltradas Lista de recetas resultante después de aplicar filtros
         */
     ...
     * Permite filtrar por categoría, dificultad y tiempo de preparación.
     *
     * @param context Contexto para crear el diálogo
     * @param viewModel ViewModel para aplicar los filtros a los datos
     * @param listener Listener para manejar los resultados del filtrado
     */
     ...
     * Incluye opción "Todas" y las categorías predefinidas de la aplicación.
     *
     * @param context Contexto para obtener strings de categorías
     ...
     * Incluye opción "Todas" y los niveles de dificultad predefinidos.
     *
     * @param context Contexto para obtener strings de dificultades
     * @param view AutoCompleteTextView a configurar
     */
