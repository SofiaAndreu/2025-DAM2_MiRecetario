...
public class ImportDialogHelper {
     ...
     * Proporciona callback cuando el usuario confirma la importación.
     */
    public interface OnUrlImportListener {
        /**
         * Se llama cuando el usuario confirma la importación de una URL.
         *
         * @param url URL de la receta a importar
         * @param dialog Diálogo que puede ser cerrado desde el callback
         */
     ...
     * Incluye campo de texto, botones de acción y indicador de progreso.
     *
     * @param context Contexto para crear el diálogo
     * @param listener Listener para manejar la confirmación de importación
     */
